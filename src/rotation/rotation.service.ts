...
export class RotationService {
  ...
  async create(empID: string, dto: UpdateRotationDto): Promise<RotationDto> {
    ...
    const validateDto: UpdateRotationDto =
    ...
    const createdRotation = await this.rotationRepository.update(
      empID,
      rotation,
    );
